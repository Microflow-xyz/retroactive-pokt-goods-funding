  ...
  if (isModal) {
            ...
            <div className="mt-20 flex w-full flex-col items-center justify-between gap-10">
              ...
              <p className="flex max-w-[40%] flex-col items-center gap-3 text-center text-xl font-bold text-onPrimary-light">
                ...
                <span className=" text-sm font-normal text-primaryContainer-light">
                  ...
                  <b>help desk</b> to ask for further help if you think there is
                  a mistake here.
                </span>
              </p>
            </div>
    ...
    if (transactionId) {
      return (
        <Layout isFullWidth>
          <Skeleton
            className="mb-1  h-40 w-full bg-slate-300"
            isLoading={loadingState}
          >
            <DndProvider backend={HTML5Backend}>
              <BallotRevocation
            ...
            <DndProvider backend={HTML5Backend}>
              ...
              <div className=" flex items-center justify-between gap-3 rounded-2xl bg-onBackground-dark px-6 py-4 text-sm font-normal text-secondary-dark">
                ...
                <p className=" w-fit">
                  ...
                  financial interest in the project (as an employee, contractor,
                  or equity holder) or the project has asked you to vote for
                  them. These may lead to the project being disqualified. (
                  <Link
                    className=" underline"
                    target="_blank"
